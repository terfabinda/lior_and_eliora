...
/// A custom Flutter widget that mimics the dimensions and appearance of a credit card.
class VRectThumbWidget extends StatelessWidget {
  ...
  /// Creates a [VRectThumbWidget].
  const VRectThumbWidget(
      {Key? key,
      required this.child,
  ...
  Widget build(BuildContext context) {
    // Dimensions of a standard credit card (approximate aspect ratio)
    const double cardWidth = 150; // Width in pixels
    const double cardHeight = 180; // Height in pixels
    return Card(
